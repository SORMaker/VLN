...
# IMAGENET_FEATURES = 'seq2seq/data/img_features/ResNet-152-places365.tsv'
IMAGENET_FEATURES = 'duet/datasets/R2R/features/img_features/ResNet-152-places365.tsv'
MAX_INPUT_LENGTH = 80
